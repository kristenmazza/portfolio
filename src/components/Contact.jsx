    ...
    <section id='contact' className={styles.contact}>
      <div className={styles.contactContainer}>
        <div className={styles.envelope}>
          <img alt='' src='/images/envelope-300px.png' />
        </div>
        <h2>Contact</h2>
        ...
        <div className={styles.contactDetails}>
          ...
          >
            <svg
              aria-labelledby='linkedin-contact'
              ...
              viewBox='0 0 16 16'
            >
              <title id='linkedin-contact'>Visit LinkedIn profile</title>
          ...
          >
            <svg
              aria-labelledby='github-contact'
              className={styles.logo}
              role='img'
              width='98'
              height='96'
              ...
              pointerEvents='all'
            >
              <title id='github-contact'>Visit Github profile</title>
