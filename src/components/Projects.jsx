      ...
      <div className={styles.projectsContainer}>
        ...
        <div className={styles.project}>
          ...
          <div className={styles.projectDetails}>
            <h3>Blog</h3>
            <p>
              Straightforward blog platform that includes a RESTful API,
              front-end integration, and user authentication. Utilized AWS S3
              for blog post image storage. Created an external interface
              tailored for admins with content management capabilities.
            </p>
            <div className={styles.technologies}>
              ...
              <div className={styles.technology}>Express.js</div>
              <div className={styles.technology}>MongoDB</div>
            </div>
            <div className={styles.previews}>
              <button
                className={styles.demoButton}
                onClick={onClickUrl('https://blog.kristenmazza.dev')}
              >
                <span>Live Demo</span>
                <svg
              ...
              <button
                ...
                onClick={onClickUrl(
                  'https://github.com/kristenmazza/blog-client',
                )}
              >
                <svg
                  className={styles.projectIcon}
